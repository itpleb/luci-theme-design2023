  ...
  <t-card :bordered="false">
    <t-row>
      <t-col :xs="12" :xl="9">
        <t-card
          :bordered="false"
          :title="$t('pages.dashboard.outputOverview.title')"
          :subtitle="$t('pages.dashboard.outputOverview.subtitle')"
      ...
      <t-col :xs="12" :xl="3">
        <t-card :bordered="false" :class="{ 'dashboard-overview-card': true, 'export-panel': true }">
          <template #actions>
            <t-button>{{ $t('pages.dashboard.outputOverview.export') }}</t-button>
          </template>
          <t-row>
            <t-col :xs="6" :xl="12">
              <t-card :bordered="false" :subtitle="$t('pages.dashboard.outputOverview.month.input')" class="inner-card">
                <div class="inner-card__content">
                  <div class="inner-card__content-title">1726</div>
                  <div class="inner-card__content-footer">
                    {{ $t('pages.dashboard.outputOverview.since') }}
            ...
            <t-col :xs="6" :xl="12">
              <t-card
                :bordered="false"
                :subtitle="$t('pages.dashboard.outputOverview.month.output')"
                class="inner-card"
              >
                <div class="inner-card__content">
