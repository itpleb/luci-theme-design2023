...
export function constructInitDataset({
  ...
  const dataset = {
    ...
    legend: {
      ...
      bottom: '0',
      orient: 'horizontal',
      data: [t('pages.dashboard.chart.thisMonth'), t('pages.dashboard.chart.lastMonth')],
    },
    series: [
      {
        name: t('pages.dashboard.chart.thisMonth'),
        data: outArray,
        type: 'bar',
      },
      {
        name: t('pages.dashboard.chart.lastMonth'),
        data: inArray,
        type: 'bar',
      },
    ],
    ...
    series: [
      {
        ...
        data: [
          {
            value: 1048,
            name: t('pages.dashboard.topPanel.analysis.channel1'),
          },
          { value: radius * 7, name: t('pages.dashboard.topPanel.analysis.channel2') },
        ],
      },
    ],
  };
